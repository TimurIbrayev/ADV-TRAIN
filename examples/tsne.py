...
from advtrain.visualization import tsne
import argparse
...
parser.add_argument('--postprocess',           default=1,         type=int,       help='1 for postprocess layer 0 for no postprocess')

#Visualization Parameters
# parser.add_argument('--mode',           default='loss_surface',        type=str,           help='Weight quantisation precision')
